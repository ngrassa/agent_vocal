#!/usr/bin/env python3
"""
Service Whisper persistant — dialecte arabe tunisien (darija).
...
log.info(f"Chargement Whisper ({WHISPER_MODEL}) — langue arabe...")
        ...
        try:
            ...
            try:
                segs, info = model.transcribe(
                    ...
                    beam_size=3,
                    vad_filter=True,
                    initial_prompt="كسكسي بريك لبلابي شاورما كفتة مرقاز سلطة تونسية كوكا ماء فريت توصيل حانوت واحد زوز ثلاثة أربعة خمسة شكراً يعيشك"
                )
